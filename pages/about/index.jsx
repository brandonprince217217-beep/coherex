  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ textAlign: "center", padding: "20px 20px 20px" }}
      >
        <h1
          style={{
            fontSize: "2.8rem",
            marginBottom: "20px",
            textShadow:
              "0 0 18px rgba(255,255,255,0.35), 0 0 32px rgba(255,255,255,0.15)"
          }}
        >
          About Coherex
        </h1>
      ...
      <div
        ...
        style={{ maxWidth: "900px", margin: "60px auto 0", padding: "0 20px" }}
      >
      ...
      <div
        className="about-section"
        style={{ maxWidth: "900px", margin: "50px auto 0", padding: "0 20px" }}
      >
        <h2 style={{ fontSize: "2rem", marginBottom: "15px" }}>
          Why Coherex Exists
        </h2>
